...
def rollLogic(side, rollZone, dot):
    if(side == 1):
        ...
        rollZone.coords(dot, 25.75, 110.25, 50.75, 135.25) # for proportions have x1 and x2 25 apart and the same for y1 and 2
        rollZone.coords(dot, 113.75, 24.25, 138.75, 49.25)
        rollZone.coords(dot, 0, 0, 0, 0)
        rollZone.coords(dot, 0, 0, 0, 0)
        rollZone.coords(dot, 0, 0, 0, 0)
        rollZone.coords(dot, 0, 0, 0, 0)
        ...
        # the side will be 3
        rollZone.coords(dot, 68.75, 64.75, 93.75, 89.75)
        rollZone.coords(dot, 25.75, 110.25, 50.75, 135.25)
        rollZone.coords(dot, 113.75, 24.25, 138.75, 49.25)
        rollZone.coords(dot, 0, 0, 0, 0)
        rollZone.coords(dot, 0, 0, 0, 0)
        rollZone.coords(dot, 0, 0, 0, 0)
        ...
        #the side will be 4
        rollZone.coords(dot, 25.75, 110.25, 50.75, 135.25) # bottom left
        rollZone.coords(dot, 113.75, 24.25, 138.75, 49.25) # top right
        rollZone.coords(dot, 113.75, 110.25, 138.75, 135.25) # bottom right
