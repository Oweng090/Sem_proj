...
def rollLogic2(side, rollZone, dot1, dot2, dot3, dot4, dot5, dot6):
    if(side == 1):
        rollZone.coords(dot1, 220, 64.75, 245, 89.75) # middle
        rollZone.coords(dot2, 0, 0, 0, 0)
        rollZone.coords(dot3, 0, 0, 0, 0)
        rollZone.coords(dot4, 0, 0, 0, 0)
        rollZone.coords(dot5, 0, 0, 0, 0)
        rollZone.coords(dot6, 0, 0, 0, 0)
    elif(side == 2):
        rollZone.coords(dot1, 177, 110.25, 202, 135.25) # bottom left
        rollZone.coords(dot2, 265, 24.25, 290, 49.25) # top right
        rollZone.coords(dot3, 0, 0, 0, 0)
        rollZone.coords(dot4, 0, 0, 0, 0)
        rollZone.coords(dot5, 0, 0, 0, 0)
        rollZone.coords(dot6, 0, 0, 0, 0)
        ...
        rollZone.coords(dot1, 177, 110.25, 202, 135.25)# bottom left
        rollZone.coords(dot2, 265, 24.25, 290, 49.25) # top right
        rollZone.coords(dot3, 220, 64.75, 245, 89.75) # middle
        rollZone.coords(dot4, 0, 0, 0, 0)
        rollZone.coords(dot5, 0, 0, 0, 0)
        rollZone.coords(dot6, 0, 0, 0, 0)
    elif(side == 4):
        rollZone.coords(dot1, 177, 110.25, 202, 135.25) # bottom left
        rollZone.coords(dot2, 265, 24.25, 290, 49.25) # top right
        rollZone.coords(dot3, 265, 110.25, 290, 135.25) # bottom right
        ...
        rollZone.coords(dot3, 265, 110.25, 290, 135.25) # bottom right
        rollZone.coords(dot4, 177, 24.25, 202, 49.25) # top left
        rollZone.coords(dot5, 220, 64.75, 245, 89.75) # middle 
        rollZone.coords(dot6, 0, 0, 0, 0)
    else:
        rollZone.coords(dot1, 177, 110.25, 202, 135.25) # bottom left
        rollZone.coords(dot2, 265, 24.25, 290, 49.25) # top right
